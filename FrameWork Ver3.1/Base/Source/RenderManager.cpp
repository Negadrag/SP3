...
void RenderManager::InitMesh()
{
	...
	//meshList[GEO_BASIC] = MeshBuilder::GenerateOBJ("Basic", "OBJ/Boss.obj");
	//meshList[GEO_BASIC]->textureArray[0] = LoadTGA("Image//Boss.tga");
	...
	meshList[GEO_SPEEDTOWER] = MeshBuilder::GenerateOBJ("Speedtower", "OBJ//Tower-SPEED.obj");
	...
	meshList[GEO_ARROW] = MeshBuilder::GenerateOBJ("Arrowtower", "OBJ//Bullet.obj");
	meshList[GEO_ARROW]->textureArray[0] = LoadTGA("Image//Bullet.tga");
